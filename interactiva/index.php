...
<body>
 <section>
  <div class="col-sm-1">
    <div id="menu">
      <div id="compartir">
        <img id="compIzq" src="Imagenes/icono/compartir.png" style="height: 65px; width: 65px" ondragenter="return enter(event)" ondragover="return over(event)" ondragleave="return leave(event)" ondrop="return compartir(event)" />
        Compartir
      </div>
   ...
   <div class="carrusel" ondragenter="return enter(event)" ondragover="return over(event)" ondragleave="return leave(event)" ondrop="return drop(event)">
     ...
     <div class="col-sm-1">
        <div id="menu">
      <div id="compartirDer">
        <img id="compDer" src="Imagenes/icono/compartir.png" style="height: 65px; width: 65px" ondragenter="return enter(event)" ondragover="return over(event)" ondragleave="return leave(event)" ondrop="return compartir(event)" />
        Compartir
      </div>
