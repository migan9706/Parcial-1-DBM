   ...
   <div class="carrusel" ondragenter="return enter(event)" ondragover="return over(event)" ondragleave="return leave(event)" ondrop="return drop(event)">
     ...
     <div class="col-sm-1">
      ...
      <div id="compartirDer">
       ...
       <div id="papeleraDer"   ondragenter="return enter(event),activoPap2()" ondragover="return over(event)" ondragleave="return leave(event),desac2()" ondrop="return eliminar(event)">
